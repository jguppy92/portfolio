...
export const projects = [
  ...
  },
  {
    ...
    engInfo: 'A front end project that harnesses a third party API to produce a random meal for users. The project was built using React, Bulma and custom Sass in a group of three members. We produced this project as a 48 hour ‘hackathon’-style challenge. I focussed in particular on hooking up the core API functionality and the get random meal page.',
