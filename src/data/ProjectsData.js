export const projects = [
  {
    ...
    info: 'A PacMan clone built entirely in Vanilla HTML5, CSS3 and JavaScript over a seven day period as a solo project. The game features full player and enemy movement, player lives and score counter, multiple levels, enemies with different behaviours and toggleable audio.',
    deployedLink: '',
    github: '',
  },
  {
    ...
    info: 'A front end project that harnesses a third party API to produce a random meal for users. The project was built using React, Bulma and custom Sass in a group of three members. We produced this project as a 48 hour ‘hackathon’-style challenge. I focussed in particular on hooking up the core API functionality and the get random meal page.',
    deployedLink: '',
    github: '',
  },
  {
